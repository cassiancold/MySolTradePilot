...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    start_text = (
        ...
        "Trade MEME tokens on Solana with real SOL safely and securely.\n\n"
        "Use the buttons below to create your wallet, deposit SOL, "
        "check balance, buy or sell MEME tokens.\n\n"
